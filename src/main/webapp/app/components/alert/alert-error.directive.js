(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('testResultNotifierApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-testResultNotifierApp-error');
                var entityKey = httpResponse.headers('X-testResultNotifierApp-params');
                if (errorHeader) {
